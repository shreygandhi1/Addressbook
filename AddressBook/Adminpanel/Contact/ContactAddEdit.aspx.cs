...
public partial class AddressBook_Admin_panel_Contact_ContactAddEdit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Request.QueryString["ContactID"] != null)
            {
                ...
                Response.Redirect("~/AddressBook/AdminPanel/Contact/ContactList.aspx");
            }
            #endregion edit Mode
