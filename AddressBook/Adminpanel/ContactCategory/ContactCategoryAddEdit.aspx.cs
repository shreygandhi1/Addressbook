...
public partial class AddressBook_Admin_panel_ContactCategory_ContactCategoryAddEdit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Request.QueryString["ContactCategoryID"] != null)
            {
                ...
                Response.Redirect("~/AddressBook/Adminpanel/ContactCategory/ContactCategoryList.aspx", true);
