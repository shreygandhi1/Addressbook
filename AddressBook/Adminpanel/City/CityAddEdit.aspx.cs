...
public partial class AddressBook_Admin_panel_City_CityAddEdit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Request.QueryString["CityID"] != null)
            {
                ...
                Response.Redirect("~/AddressBook/Adminpanel/City/CityList.aspx");
            }
            else
            {
                // Add Mode
                objCmd.CommandText = "PK_City_Insert";
                objCmd.ExecuteNonQuery();
